...
# Get the HTML language setting from the environment variables
        ...
        try:
            ...
            if Text:
                ...
                if InputLanguage.lower() == "en" or "en" in InputLanguage.lower():
                    ...
                    # If the input language is not English, translate the text
...
if __name__ == "__main__":
        while True:
            # Continuously perform speech recognition
